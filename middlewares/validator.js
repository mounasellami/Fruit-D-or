   //njm ikoun 3andi akthar mn middleware than that why i do docier middleware
...
exports.loginRules = () => [
   ...
   check(`password`, `Password must contain 6 characters`).isLength({min: 6,  max: 20})
];
...
exports.validator=(req, res, next)=>{ 
    ...
    errors.isEmpty() ? next() : res.status(400).json({errors: errors.array() }); //HETHA bech irja3 tab fih err
